...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 482.0, 402.0, 108.0, 50.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 595.0, 406.0, 105.0, 23.0 ],
									"rnbo_classname" : "route",
									"rnbo_serial" : 3,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 595.0, 373.0, 33.0, 23.0 ],
									"rnbo_classname" : "pack",
									"rnbo_extra_attributes" : 									{
										"list" : "",
										"length" : 0.0
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1017.0, 146.0, 48.0, 23.0 ],
									"rnbo_classname" : "set",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 733.0, 48.5, 150.0, 64.0 ],
									"text" : "Note 61 = kick1\nNote 62 = snare1\nNote 63 = hihat1\nNote 64 = clap1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 1010.0, 230.0, 134.0, 23.0 ],
									"rnbo_classname" : "groove~",
									"rnbo_extra_attributes" : 									{
										"channels" : 1.0,
										"synctype" : "relative",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 1113.0, 633.0, 164.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 934.0, 633.0, 174.0, 23.0 ],
									"rnbo_classname" : "buffer~",
									"rnbo_extra_attributes" : 									{
										"samplerate" : 0.0,
										"fill" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 750.0, 633.0, 178.0, 23.0 ],
									"rnbo_classname" : "buffer~",
									"rnbo_extra_attributes" : 									{
										"samplerate" : 0.0,
										"fill" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 581.0, 633.0, 163.0, 23.0 ],
									"rnbo_classname" : "buffer~",
									"rnbo_extra_attributes" : 									{
										"samplerate" : 0.0,
										"fill" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 1017.0, 109.0, 217.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"displayorder" : "-",
										"sendinit" : 1,
...
,
									"text" : "param rate @value 1 @min 0. @max 100",
									"varname" : "rate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 532.0, 545.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 398.0, 276.0, 604.5, 276.0 ],
									"order" : 1,
									"source" : [ "obj-106", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 373.5, 648.0, 495.0, 648.0, 495.0, 534.0, 541.5, 534.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1026.5, 216.0, 873.5, 216.0 ],
									"order" : 2,
									"source" : [ "obj-30", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1026.5, 216.0, 1019.5, 216.0 ],
									"order" : 1,
									"source" : [ "obj-30", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1026.5, 216.0, 1165.5, 216.0 ],
									"order" : 0,
									"source" : [ "obj-30", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 1026.5, 216.0, 734.5, 216.0 ],
									"order" : 3,
									"source" : [ "obj-30", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 493.5, 319.0, 588.0, 319.0, 588.0, 319.0, 618.5, 319.0 ],
									"order" : 0,
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-11", 0 ],
									"midpoints" : [ 724.0, 534.0, 541.5, 534.0 ],
									"source" : [ "obj-47", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-17", 0 ],
									"midpoints" : [ 777.5, 216.0, 1019.5, 216.0 ],
									"source" : [ "obj-53", 2 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-11", 0 ],
									"midpoints" : [ 863.0, 534.0, 541.5, 534.0 ],
									"source" : [ "obj-54", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-11", 0 ],
									"midpoints" : [ 1010.0, 534.0, 541.5, 534.0 ],
									"source" : [ "obj-55", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-11", 0 ],
									"midpoints" : [ 1155.0, 534.0, 541.5, 534.0 ],
									"source" : [ "obj-56", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 604.5, 474.0, 724.0, 474.0 ],
									"source" : [ "obj-62", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 626.0, 474.0, 863.0, 474.0 ],
									"source" : [ "obj-62", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 647.5, 474.0, 1010.0, 474.0 ],
									"source" : [ "obj-62", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 669.0, 474.0, 1155.0, 474.0 ],
									"source" : [ "obj-62", 3 ]
								}
...
,
					"patching_rect" : [ 131.0, 417.0, 121.0, 22.0 ],
					"rnboattrcache" : 					{
						"beat" : 						{
							"label" : "beat",
							"isEnum" : 0,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 1 ],
					"midpoints" : [ 425.5, 381.0, 242.5, 381.0 ],
					"source" : [ "obj-5", 0 ]
				}
